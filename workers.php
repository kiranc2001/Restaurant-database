...
if(isset($_POST['submit']))
{
    ...
    $salary=$_POST['salary'];
    $phone=$_POST['phone'];
    $sql_query="INSERT INTO workers
     (worker_id,name,address,salary,phone)
    ...
    <body>
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="WorkersDetails.php">Worker list</a></li>
            </ul>
        </div>
       

           
        <form class="box" action="workers.php" method="post">
            <h1>WORKERS</h1>

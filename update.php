...
.box input[type="submit"]:hover
{
    ...
    <body>
        ...
        <form class="box" action="update.php" method="post">
            ...
            <input type="text" name="manager_id" value="<?php echo $row['manager_id'];?>" placeholder="manager_id">
            <input type="text" name="manager_name" value="<?php echo $row['manager_name'];?>" placeholder="manager_name">
...
if(isset($_POST['submit']))
{
    ...
    $phone=$_POST['phone'];
         ...
         $sql_query="update hotel set manager_id='$manager_id', manager_name='$manager_name',phone='$phone' where manager_id='$manager_id' ";
